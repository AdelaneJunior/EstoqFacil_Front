...
export class ProdutoControllerService extends BaseService {
  ...
  /**
   * Path part for operation produtoControllerListAllWithSort
   */
  static readonly ProdutoControllerListAllWithSortPath = '/api/v1/produto/sort/{field}';

  /**
   * Reliza busca ordenada de acordo com o campo
   *
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
   * To access only the response body, use `produtoControllerListAllWithSort()` instead.
   *
   * This method doesn't expect any request body.
   */
  produtoControllerListAllWithSort$Response(params: {
    field: string;
  },
  context?: HttpContext
    ...
    const rb = new RequestBuilder(this.rootUrl, ProdutoControllerService.ProdutoControllerListAllWithSortPath, 'get');
    if (params) {
   ...
   *
   * This method provides access only to the response body.
   * To access the full response (for headers, for example), `produtoControllerListAllWithSort$Response()` instead.
   *
   * This method doesn't expect any request body.
   */
  produtoControllerListAllWithSort(params: {
    field: string;
  },
  context?: HttpContext
    ...
    return this.produtoControllerListAllWithSort$Response(params,context).pipe(
      map((r: StrictHttpResponse<any>) => r.body as any)
    );
  }

  /**
   * Path part for operation produtoControllerCount
   */
  static readonly ProdutoControllerCountPath = '/api/v1/produto/pagination';

  /**
   * Busca a quantidade de registros
   *
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
   * To access only the response body, use `produtoControllerCount()` instead.
   *
   * This method doesn't expect any request body.
   */
  produtoControllerCount$Response(params?: {
  },
  context?: HttpContext

): Observable<StrictHttpResponse<any>> {

    const rb = new RequestBuilder(this.rootUrl, ProdutoControllerService.ProdutoControllerCountPath, 'get');
    if (params) {
    }
   ...
   *
   * This method provides access only to the response body.
   * To access the full response (for headers, for example), `produtoControllerCount$Response()` instead.
   *
   * This method doesn't expect any request body.
   */
  produtoControllerCount(params?: {
  },
  context?: HttpContext

): Observable<any> {

    return this.produtoControllerCount$Response(params,context).pipe(
      map((r: StrictHttpResponse<any>) => r.body as any)
    );
  }

  /**
   * Path part for operation produtoControllerListProdutosWithPagination
   */
  static readonly ProdutoControllerListProdutosWithPaginationPath = '/api/v1/produto/pagination/{offset}/{pageSize}';

  /**
   * Realiza busca paginada de acordo com o tamanho da pagina e a pagina
   *
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
   * To access only the response body, use `produtoControllerListProdutosWithPagination()` instead.
   *
   * This method doesn't expect any request body.
   */
  produtoControllerListProdutosWithPagination$Response(params: {
    offset: number;
    pageSize: number;
  },
  context?: HttpContext
    ...
    const rb = new RequestBuilder(this.rootUrl, ProdutoControllerService.ProdutoControllerListProdutosWithPaginationPath, 'get');
    if (params) {
   ...
   *
   * This method provides access only to the response body.
   * To access the full response (for headers, for example), `produtoControllerListProdutosWithPagination$Response()` instead.
   *
   * This method doesn't expect any request body.
   */
  produtoControllerListProdutosWithPagination(params: {
    offset: number;
    pageSize: number;
  },
  context?: HttpContext
